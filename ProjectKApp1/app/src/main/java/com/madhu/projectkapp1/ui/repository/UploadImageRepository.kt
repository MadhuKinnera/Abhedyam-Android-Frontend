...
class UploadImageRepository @Inject constructor(
    private val uploadImageDataSource: UploadImageDataSource
) {

    private val tag = "UploadImageRepository"

    suspend fun uploadImageToCloudinary(image: MultipartBody.Part): Flow<ResourceState<JwtResponse>> {
        ...
        return flow {
            ...
            val response =
                uploadImageDataSource.uploadImageToCloudinary(image)
